...
<div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
  ...
  <div class="flex gap-10">
    ...
    <a href="https://github.com/hanklikesmatcha" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="GitHub">
      <svg class="social-icon" width="28" height="28" viewBox="0 0 24 24" fill="#d1d5db" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- LinkedIn Icon -->
    <a href="https://linkedin.com/in/szuhan-eng" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="LinkedIn">
      <svg class="social-icon" width="28" height="28" viewBox="0 0 24 24" fill="#d1d5db" xmlns="http://www.w3.org/2000/svg">
